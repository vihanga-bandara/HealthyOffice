...
const threshold = 15; //this is the highest value before the server realises a person is not at his/her seat
...
function getDuration(){
    ...
    console.log("Found difference. Sending to database");
}

function getMail(){
timeCheck =  moment();
 var difference = moment.utc(moment(endTime,"DD/MM/YYYY HH:mm:ss").diff(moment(timeCheck,"DD/MM/YYYY HH:mm:ss"))).format("HH:mm:ss");
